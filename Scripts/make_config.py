...
"""
this script puts together the config file for the Snakemake pipeline
...
## other info:
    ...
    parser.add_argument("--clust_config",
                        ...
                        help="Path to tabfile holding samples information")
    parser.add_argument("--username",
                        default="desiree.tillo@nih.gov",
                        help="email")
...
if __name__ == "__main__":
    ...
    elif args["exp_type"]=="generic":
        samps,samp_vec=parse_samples_RRBS(args["meta"])
        project["samples"]=samps
        project["sample_vector"]=samp_vec
